...
- waves / Crossed Flames (2026-07-10, matched to the original after research): ONE ring (205 px/s — faster than run speed, forcing the tumble; 230 in phase 3) expands to 360px (450 in phase 3) then CONTRACTS back; hits once outbound and once inbound; the witch stands still for the whole cycle — the intended counter is either keeping distance (ring has finite reach) or dashing through to punish her during the hold.
